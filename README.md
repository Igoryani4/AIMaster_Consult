...
- Основная функция приложения помощь автовладельцу с Диагностикой, Помощью на дороге, 
Запись на ремонтб консультации, заказ запчастей, поределение местоположения авто и отправка на 
помощь специалистаили вызов эвакуатора, прямая связь с механиком,   
